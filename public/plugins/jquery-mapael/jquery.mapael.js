...
(function (factory) {
    ...
    Mapael.prototype = {
         ...
         *          - Apply translation: take into articles the map offset in the page
         *          ** from this point, we have relative mouse coordinate
         *          - Apply homothetic transformation: take into articles initial factor of map sizing (fullWidth / actualWidth)
         *          - Apply homothetic transformation: take into articles the zoom factor
         *          ** from this point, we have relative map coordinate
         *          - Apply translation: take into articles the current panning of the map
